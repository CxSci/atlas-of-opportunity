  ...
  redrawBridges = (e) => {
    ...
    switch (this.props.flowDirection) {
      case Constants.FLOW_OUT:
        bridges = [clickedSA2.properties.outflow_r1, clickedSA2.properties.outflow_r2, clickedSA2.properties.outflow_r3];
        break;
      case Constants.FLOW_BI:
        bridges = [clickedSA2.properties.bridge_rank1, clickedSA2.properties.bridge_rank2, clickedSA2.properties.bridge_rank3];
        break;
      case Constants.FLOW_IN:
      default:
        bridges = [clickedSA2.properties.inflow_r1, clickedSA2.properties.inflow_r2, clickedSA2.properties.inflow_r3];
    }
    ...
    function animate(featureIdx, cntr, point, route, pointID) {
      ...
      let a = turf.point(route.features[featureIdx].geometry.coordinates[cntr >= steps ? cntr - 1 : cntr]);
      let b = turf.point(route.features[featureIdx].geometry.coordinates[cntr >= steps ? cntr : cntr + 1]);
